...
export default function App() {
  ...
  return <main><header><p className="eyebrow">HALIFAX, NOVA SCOTIA</p><h1>Tree inspection priority</h1><p>Visual screening leads for professional inspection.</p></header>
